...
p = {
  ...
  'result_filenames': [
    '/home/ubuntu/hjw/code/Ref-GeoTransformer/output/geotransformer.modelnet.rpmnet.stage4.gse.k3.max.oacl.stage2.sinkhorn/result/csv/cordi-foldnet-pbr-550000_lm-test.csv',
  ],
